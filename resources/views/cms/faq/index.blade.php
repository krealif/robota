    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="table-responsive">
              ...
              <tr>
                ...
                <td>
                  <div class="btn-list flex-nowrap">
                    <a href="{{ route('faq.edit', $faq->id) }}" class="btn">
                      Edit
                    </a>
                    <button id="delete" class="btn" data-bs-toggle="modal" data-bs-target="#modal-delete" onclick="deleteItem({{ $faq->id }})">
                      Delete
                    </button>
                  </div>
                </td>
          ...
          @else
              <div class="card-body">There are no FAQ yet.</div>
          @endif
        </div>
...
<script>
  function deleteItem(id) {
    ...
    deleteForm.action = '{{ route('faq.index') }}/' + id;
  }
</script>
@endpush