    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="table-responsive">
              ...
              <tr>
                ...
                <td>
                  <div class="btn-list flex-nowrap">
                    <a href="{{ route('testimonial.edit', $testimonial->id) }}" class="btn">
                      Edit
                    </a>
                    <button id="delete" class="btn" data-bs-toggle="modal" data-bs-target="#modal-delete" onclick="deleteItem({{ $testimonial->id }})">
                      Delete
                    </button>
                  </div>
                </td>
          ...
          @else
              <div class="card-body">There are no Testimonial yet.</div>
          @endif
        </div>
        <div class="card-footer">
          {{ $dataTestimonial->links() }}
        </div>
      </div>
    </div>
  </div>
...
<script>
  function deleteItem(id) {
    ...
    deleteForm.action = '{{ route('testimonial.index') }}/' + id;
  }
</script>
@endpush