...
<section class="container-xl py-12">
  <div class="row g-6 g-md-10">
    ...
    <div class="col-md-8">
      <h3 class="fs-3 fw-bold">What is Robota</h3>
      <p class="fs-5 m-0">Robota Hotel and Tourism Intelligence is an application that performs hospitality and tourism analysis with Artificial Intelligence (AI) technology. The Robota application provides analytical solutions for hospitality and tourism including competitor analysis, pricing, and customer reviews. This application is a collaboration between PT. Global Data Inspiration (Datains) and PT. Metropolitan Golden Management (MGM).</p>
    </div>
  </div>
</section>
<hr>
<section class="container-xl py-12">
  <div class="row g-6 g-md-10">
    ...
    <div class="col-md-8">
      <h3 class="fs-3 fw-bold">Our Mission</h3>
